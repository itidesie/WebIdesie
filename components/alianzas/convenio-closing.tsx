...
interface ConvenioClosingProps {
  title: string
  text: string
  ctaLabel: string
  ctaHref: string
...
export function ConvenioClosing({ title, text, ctaLabel, ctaHref }: ConvenioClosingProps) {
  return (
    <section className="w-full bg-gray-950 py-20 text-center md:py-28">
      <div className="mx-auto max-w-2xl px-6 sm:px-8">
        <h2 className="convenio-title text-white">{title}</h2>
